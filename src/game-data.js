(() => {
  ...
  const buildPads = [
    { x: 42, y: 214 }, { x: 180, y: 152 }, { x: 300, y: 189 }, { x: 188, y: 296 },
    { x: 318, y: 380 }, { x: 60, y: 424 }, { x: 216, y: 450 }, { x: 250, y: 575 },
  ];
  ...
  const enemies = {
    ...
    titan: { name: "Titan", hp: 540, speed: 26, armor: 8, bounty: 48, leak: 4, color: 0x8e8379, size: 26 },
    boss: { name: "Warden", hp: 1180, speed: 22, armor: 7, bounty: 130, leak: 8, color: 0xcd65e6, size: 32, phases: true },
  };
