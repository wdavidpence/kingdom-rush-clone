...
CODE_SYS = "Output ONLY one ```diff:public/src/krc-art.js fence using existing ellipse() calls. Radius >= 1.5. No invented APIs."
SYNTH_SYS = "Synthesize ONE final diff. Output ONLY ```diff:public/src/krc-art.js. Three ellipse sparks radius >= 1.5 before drawMageFire closes."
