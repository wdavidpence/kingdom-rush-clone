...
CODE_SYS = "Output ONLY one ```diff:public/src/game.js fence. Use this.campaignIntelBg. Do not invent campaignNodes. Do not skip Forest Gate."
SYNTH_SYS = "Synthesize ONE final diff. Output ONLY ```diff:public/src/game.js. Store this.campaignIntelBg and biome-stroke it in setCampaignIntel."
