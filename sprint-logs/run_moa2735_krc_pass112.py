#!/usr/bin/env python3
"""PenceMOA qwen2735 1.1.2: spear overlap. SAME assignment, plan||plan, code||code, synth."""
import json, time, urllib.request, concurrent.futures
from pathlib import Path

LOG = Path("/Users/davidpence/kingdom-rush-clone/sprint-logs")
TASK = (LOG / "pass-1.1.2-moa-prompt.md").read_text()
...
SYNTH_SYS = "Synthesize ONE final diff from A and B. Output ONLY one ```diff:public/src/krc-art.js fence. Do not close extra braces. Keep 24-28px guards. Left spear x<=52, right spear x>=82."
