KRC 1.3.14 qwen35 ONE task (not MoA): rewrite drawHeroCaptainIdle so the captain reads as a hero at play scale.

Play scale ~64x72 (keep make sizes). Wow: HELM + FACE + CAPE + SWORD. Fat #141008. Huge cream eyes. Blue/gold. Not a blue stamp.

Keep:
    make("hero_captain_idle", 64, 72, drawHeroCaptainIdle);
    make("hero_captain", 64, 72, drawHeroCaptainIdle);
Do not change 64, 72.
Do NOT edit drawScout, drawBrute, drawFlyer, drawTitan, drawBossIdle, projectile_magic, drawHeroCaptainAttack, drawHeroCaptainAbility.

LIVE drawHeroCaptainIdle:
