...
CODE_SYS = "Output ONLY one ```diff:public/src/krc-art.js fence using existing poly() calls. No fillRect. No invented APIs."
SYNTH_SYS = "Synthesize ONE final diff. Output ONLY ```diff:public/src/krc-art.js. Use poly() only. Two visor slits on the live helm polys."
