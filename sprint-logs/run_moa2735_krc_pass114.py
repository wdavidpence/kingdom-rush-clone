...
CODE_SYS = "Output ONLY one ```diff:public/src/krc-art.js fence using existing ellipse() calls. No invented APIs."
SYNTH_SYS = "Synthesize ONE final diff. Output ONLY ```diff:public/src/krc-art.js. Four ellipse sparks before drawThatchRoof128. Use ellipse() only."
