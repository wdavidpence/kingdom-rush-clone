#!/usr/bin/env python3
"""PenceMOA qwen2735: SAME gate-splinter assignment. plan||plan, code||code, synth."""
import json, time, urllib.request, concurrent.futures
from pathlib import Path

LOG = Path("/Users/davidpence/kingdom-rush-clone/sprint-logs")
TASK = (LOG / "pass-1.0.104-gate-moa-prompt.md").read_text()
...
CODE_SYS = "Output ONLY one ```diff:public/src/game.js fence. No prose after it."
SYNTH_SYS = "Synthesize ONE final diff from A and B. Output ONLY one ```diff:public/src/game.js fence."
