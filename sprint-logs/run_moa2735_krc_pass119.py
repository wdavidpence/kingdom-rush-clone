...
CODE_SYS = "Output ONLY one ```diff:public/src/game.js fence. Use MAPS.forEach index. Do not invent campaignNodes. Do not skip Forest Gate."
SYNTH_SYS = "Synthesize ONE final diff. Output ONLY ```diff:public/src/game.js. Locked hover biome stroke, restore 0x4a554a. Keep Forest Gate hover."
