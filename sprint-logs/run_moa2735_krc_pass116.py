...
CODE_SYS = "Output ONLY one ```diff:public/src/game.js fence. Use setStrokeStyle. Do not move Forest Gate. No invented APIs."
SYNTH_SYS = "Synthesize ONE final diff. Output ONLY ```diff:public/src/game.js. Biome hover strokes by index. onOut stays gold. Do not move node positions."
